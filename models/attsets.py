...
class AttentionSets(nn.Module):
    def __init__(self, W=256, input_ch=3, attention_output_length=512):
        ...
        self.dense_layer_4 = nn.Linear(in_features=self.attention_output_length,
                                       out_features=self.attention_output_length)  # dense6

    def forward(self, inputs, embeded_pts):
        input_init = torch.cat([inputs, embeded_pts], -1)
        ...
        return self.dense_layer_4(output)
