...
def get_embedder(multires, i=0, device=device):
    if i == -1:
...
# Ray helpers
def get_rays(H, W, focal, c2w, cx=None, cy=None, device_cur=device):
...
def config_parser():
    ...
    parser.add_argument('--config', is_config_file=True, default='dataset/Obama/TorsoNeRF_config.txt',
